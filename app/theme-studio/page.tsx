...
import { WebsiteBuilder } from '@/components/theme-studio/website-builder/website-builder';
import { Eye, Download, History, Settings, Globe } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Customize your theme and build your website</p>
            </div>
            <div className="flex items-center gap-2">
              {deviceCapabilities && (
                <Badge variant="outline">
                  {deviceCapabilities.type} • {deviceCapabilities.screen.width}x
                  {deviceCapabilities.screen.height}
                </Badge>
              )}
      ...
      <div className="container mx-auto px-4 py-6">
        <div className={`grid gap-6 ${activeTab === 'website' ? 'grid-cols-1' : 'grid-cols-1 lg:grid-cols-3'}`}>
          {/* Editor Panel */}
          <div className={activeTab === 'website' ? 'col-span-1' : 'lg:col-span-2'}>
            <Card>
              <CardHeader>
          ...
          {/* Sidebar - Only show when not in website builder mode */}
          {activeTab !== 'website' && (
